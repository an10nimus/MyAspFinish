...
\begin{align}
	&\hat{\gamma}' = \frac{2\ve_\|}{\ve_\bot} - 1 - \frac{2\ve_\|}{\ve_\bot} \sqrt{1 - \frac{\ve_\bot}{\ve_\|}},\\
...
\begin{figure}
	...
	\caption{Схематическое изображение профилей без участков насыщения при $\mu_0 = \ve_\bot/\ve_a$ и $\mu_L = \ve_\|/\ve_a$.}\label{fig:ch5_profile_2}
\end{figure}
...
\todo{Продолжение работы: дорешать уравнение $-b>L$, посмотреть, не заменить ли тут всё на $\varkappa$}


\todo{(Потом)} Выясним, какой параметр отвечает за то, какое переходное напряжение будет меньше, $\tilde{U}$ или $\hat{U}'$.
